...
int main() {
    ...
    adicionarObra(&museu, 3, 1, "História da Copa do Mundo", "FIFA", "Este tema apresenta a história da Copa do Mundo, desde sua primeira edição em 1930 até os preparativos para a edição de 2026. Explore os momentos mais memoráveis, as equipes vitoriosas e as mudanças ao longo das décadas.", "1930-2026");
    adicionarObra(&museu, 3, 2, "Estádios e Infraestrutura da Copa do Mundo 2026", "Comitê Organizador", "Neste tema, você pode conhecer os estádios e a infraestrutura preparada para a Copa do Mundo de 2026. Descubra os locais onde os jogos serão realizados, as inovações tecnológicas e as expectativas para o torneio.", "2026");
    adicionarObra(&museu, 3, 3, "Impacto da Copa do Mundo na Cultura e Economia", "Países Anfitriões", "Explore como a Copa do Mundo influencia a cultura e a economia dos países anfitriões. Discuta o turismo, a indústria do entretenimento, as tradições culturais e o legado econômico deixado pelo torneio.", "2026");
